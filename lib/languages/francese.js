...
installIntro: () => "Vous souhaitez installer ƌɽɛɑƌ-ʙᴏᴛ Bot sur votre appareil ?",
...
notAvailable: () => "⚠️ Cette commande est disponible uniquement avec la base de ƌɽɛɑƌ-ʙᴏᴛ",
...
socialMainFooter: () => "Restez connecté avec ƌɽɛɑƌ-ʙᴏᴛ",
...
socialFollowUpFooter: () => "ƌɽɛɑƌ-ʙᴏᴛ - Toujours connectés",
...
broadcastHeader: () => "꒷꒦ ✦ Message de ƌɽɛɑƌ-ʙᴏᴛ ✦ ꒷꒦",
...
ytSearchMissingFiles: () => "❗ Pour utiliser cette commande, utilisez la base de ƌɽɛɑƌ-ʙᴏᴛ",
ytSearchMissingQuery: () => "╭﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱\n 📌 Veuillez saisir le nom de la vidéo\n Exemple : .ytsearch compilation\n╰﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱",
ytSearchNoResults: () => "╭﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱\n ❌ Aucun résultat trouvé\n╰﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱",
ytSearchTitle: () => "🔎 Recherche YouTube",
ytSearchFooter: () => "ƌɽɛɑƌ-ʙᴏᴛ ✦ Téléchargeur",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *CASINO*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ Comment jouer ✦ ꒷꒦\n\nEntrez la quantité de 💶 UnityCoins à miser contre *ƌɽɛɑƌ-ʙᴏᴛ-Bot*\n\n📌 Exemple :\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ Choisissez une mise ci-dessous !\n╰★────★────★╯`,
betCooldown: ({ time }) => `╭﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱\n  ━━✫ 🚩 Vous avez déjà misé\n  ━━✫ Attendez ⏱ ${time}\n╰﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱`,
