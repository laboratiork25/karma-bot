...
menuownerAdminMenuButton: () => "🛡️ Menu Admin/Mod",
...
installIntro: () => "Vous souhaitez installer ₭𐌀Ɽ₥𐌀-𐌱𐍉𐍄 Bot sur votre appareil ?",
...
notAvailable: () => "⚠️ Cette commande est disponible uniquement avec la base de ₭𐌀Ɽ₥𐌀-𐌱𐍉𐍄",
...
mainFooter: () => "Powered by ₭𐌀Ɽ₥𐌀-𐌱𐍉𐍄",
...
socialMainFooter: () => "Restez connecté avec ₭𐌀Ɽ₥𐌀-𐌱𐍉𐍄",
...
socialFollowUpFooter: () => "₭𐌀Ɽ₥𐌀-𐌱𐍉𐍄 - Toujours connectés",
...
broadcastHeader: () => "꒷꒦ ✦ Message de ₭𐌀Ɽ₥𐌀-𐌱𐍉𐍄 ✦ ꒷꒦",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *CASINO*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ Comment jouer ✦ ꒷꒦\n\nEntrez la quantité de 💶 UnityCoins à miser contre *₭𐌀Ɽ₥𐌀-𐌱𐍉𐍄-Bot*\n\n📌 Exemple :\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ Choisissez une mise ci-dessous !\n╰★────★────★╯`,
betCooldown: ({ time }) => `╭﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱\n  ━━✫ 🚩 Vous avez déjà misé\n  ━━✫ Attendez ⏱ ${time}\n╰﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱`,
