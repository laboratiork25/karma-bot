...
installIntro: () => "Vous souhaitez installer ₭𐌀Ɽ₥𐌀 Bot sur votre appareil ?",
...
notAvailable: () => "⚠️ Cette commande est disponible uniquement avec la base de ₭𐌀Ɽ₥𐌀",
...
socialFollowUpFooter: () => "₭𐌀Ɽ₥𐌀 - Toujours connectés",
...
linkgroupLinkFooter: () => "Powered by ₭𐌀Ɽ₥𐌀 Bot",
...
broadcastHeader: () => "꒷꒦ ✦ Message de ₭𐌀Ɽ₥𐌀 ✦ ꒷꒦",
...
translateFooter: () => "₭𐌀Ɽ₥𐌀 Translator",
...
imageSearchFooter: () => "Powered by ₭𐌀Ɽ₥𐌀",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *CASINO*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ Comment jouer ✦ ꒷꒦\n\nEntrez la quantité de 💶 UnityCoins à miser contre *₭𐌀Ɽ₥𐌀-Bot*\n\n📌 Exemple :\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ Choisissez une mise ci-dessous !\n╰★────★────★╯`,
betCooldown: ({ time }) => `╭﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱\n  ━━✫ 🚩 Vous avez déjà misé\n  ━━✫ Attendez ⏱ ${time}\n╰﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱`,
