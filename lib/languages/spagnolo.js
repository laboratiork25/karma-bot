...
installIntro: () => "¿Quieres instalar ƌɽɛɑƌ-ʙᴏᴛ Bot en tu dispositivo?",
...
notAvailable: () => "⚠️ Este comando solo está disponible con la base de ƌɽɛɑƌ-ʙᴏᴛ",
...
socialMainFooter: () => "Mantente conectado con ƌɽɛɑƌ-ʙᴏᴛ",
...
socialFollowUpFooter: () => "ƌɽɛɑƌ-ʙᴏᴛ - Siempre conectados",
...
broadcastHeader: () => "꒷꒦ ✦ Mensaje de ƌɽɛɑƌ-ʙᴏᴛ ✦ ꒷꒦",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *CASINO*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ Cómo jugar ✦ ꒷꒦\n\nIngresa la cantidad de 💶 UnityCoins para apostar contra *ƌɽɛɑƌ-ʙᴏᴛ-Bot*\n\n📌 Ejemplo:\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ ¡Elige una denominación abajo!\n╰★────★────★╯`,
betCooldown: ({ time }) => `╭﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱\n  ━━✫ 🚩 Ya has apostado\n  ━━✫ Espera ⏱ ${time}\n╰﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱`,
