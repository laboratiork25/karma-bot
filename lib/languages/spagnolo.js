...
installIntro: () => "¿Quieres instalar ₭𐌀Ɽ₥𐌀 Bot en tu dispositivo?",
...
notAvailable: () => "⚠️ Este comando solo está disponible con la base de ₭𐌀Ɽ₥𐌀",
...
socialMainFooter: () => "Mantente conectado con ₭𐌀Ɽ₥𐌀",
...
socialFollowUpFooter: () => "₭𐌀Ɽ₥𐌀 - Siempre conectados",
...
broadcastHeader: () => "꒷꒦ ✦ Mensaje de ₭𐌀Ɽ₥𐌀 ✦ ꒷꒦",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *CASINO*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ Cómo jugar ✦ ꒷꒦\n\nIngresa la cantidad de 💶 UnityCoins para apostar contra *₭𐌀Ɽ₥𐌀-Bot*\n\n📌 Ejemplo:\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ ¡Elige una denominación abajo!\n╰★────★────★╯`,
betCooldown: ({ time }) => `╭﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱\n  ━━✫ 🚩 Ya has apostado\n  ━━✫ Espera ⏱ ${time}\n╰﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱`,
