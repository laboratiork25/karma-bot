...
installIntro: () => "Quer instalar o ₭𐌀Ɽ₥𐌀 Bot no seu dispositivo?",
...
notAvailable: () => "⚠️ Este comando está disponível apenas com a base do ₭𐌀Ɽ₥𐌀",
...
socialMainFooter: () => "Mantenha-se conectado com o ₭𐌀Ɽ₥𐌀",
...
socialFollowUpFooter: () => "₭𐌀Ɽ₥𐌀 - Sempre conectados",
...
broadcastHeader: () => "꒷꒦ ✦ Mensagem do ₭𐌀Ɽ₥𐌀 ✦ ꒷꒦",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *CASSINO*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ Como jogar ✦ ꒷꒦\n\nInsira a quantidade de 💶 UnityCoins para apostar contra *₭𐌀Ɽ₥𐌀-Bot*\n\n📌 Exemplo:\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ Escolha um valor abaixo!\n╰★────★────★╯`,
betCooldown: ({ time }) => `╭﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱\n  ━━✫ 🚩 Você já apostou\n  ━━✫ Aguarde ⏱ ${time}\n╰﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱`,
