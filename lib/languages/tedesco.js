...
installIntro: () => "Möchtest du ₭𐌀Ɽ₥𐌀 Bot auf deinem Gerät installieren?",
...
notAvailable: () => "⚠️ Dieser Befehl ist nur mit der ₭𐌀Ɽ₥𐌀-Basis verfügbar",
...
socialMainFooter: () => "Bleibe mit ₭𐌀Ɽ₥𐌀 verbunden",
...
socialFollowUpFooter: () => "₭𐌀Ɽ₥𐌀 - Immer verbunden",
...
broadcastHeader: () => "꒷꒦ ✦ Nachricht von ₭𐌀Ɽ₥𐌀 ✦ ꒷꒦",
...
ytSearchMissingFiles: () => "❗ Um diesen Befehl zu verwenden, benutze die ₭𐌀Ɽ₥𐌀-Basis",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *CASINO*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ So spielst du ✦ ꒷꒦\n\nGib die Anzahl der 💶 UnityCoins ein, die du gegen *₭𐌀Ɽ₥𐌀-Bot* setzen möchtest\n\n📌 Beispiel:\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ Wähle unten einen Betrag!\n╰★────★────★╯`,
