...
installIntro: () => "Möchtest du ƌɽɛɑƌ-ʙᴏᴛ Bot auf deinem Gerät installieren?",
...
notAvailable: () => "⚠️ Dieser Befehl ist nur mit der ƌɽɛɑƌ-ʙᴏᴛ-Basis verfügbar",
...
socialMainFooter: () => "Bleibe mit ƌɽɛɑƌ-ʙᴏᴛ verbunden",
...
socialFollowUpFooter: () => "ƌɽɛɑƌ-ʙᴏᴛ - Immer verbunden",
...
broadcastHeader: () => "꒷꒦ ✦ Nachricht von ƌɽɛɑƌ-ʙᴏᴛ ✦ ꒷꒦",
...
ytSearchMissingFiles: () => "❗ Um diesen Befehl zu verwenden, benutze die ƌɽɛɑƌ-ʙᴏᴛ-Basis",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *CASINO*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ So spielst du ✦ ꒷꒦\n\nGib die Anzahl der 💶 UnityCoins ein, die du gegen *ƌɽɛɑƌ-ʙᴏᴛ-Bot* setzen möchtest\n\n📌 Beispiel:\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ Wähle unten einen Betrag!\n╰★────★────★╯`,
