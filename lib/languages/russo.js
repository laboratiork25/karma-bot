...
installIntro: () => "Хотите установить ƌɽɛɑƌ-ʙᴏᴛ Bot на свое устройство?",
...
notAvailable: () => "⚠️ Эта команда доступна только с базой ƌɽɛɑƌ-ʙᴏᴛ",
...
socialMainFooter: () => "Оставайтесь на связи с ƌɽɛɑƌ-ʙᴏᴛ",
...
socialFollowUpFooter: () => "ƌɽɛɑƌ-ʙᴏᴛ - Всегда на связи",
...
broadcastHeader: () => "꒷꒦ ✦ Сообщение от ƌɽɛɑƌ-ʙᴏᴛ ✦ ꒷꒦",
...
ytSearchMissingFiles: () => "❗ Для использования этой команды используйте базу ƌɽɛɑƌ-ʙᴏᴛ",
...
translateFooter: () => "ƌɽɛɑƌ-ʙᴏᴛ Переводчик",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *КАЗИНО*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ Как играть ✦ ꒷꒦\n\nВведите количество 💶 UnityCoins для ставки против *ƌɽɛɑƌ-ʙᴏᴛ-Bot*\n\n📌 Пример:\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ Выберите ставку ниже!\n╰★────★────★╯`,
