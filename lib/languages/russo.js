...
installIntro: () => "Хотите установить ₭𐌀Ɽ₥𐌀 Bot на свое устройство?",
...
notAvailable: () => "⚠️ Эта команда доступна только с базой ₭𐌀Ɽ₥𐌀",
...
socialMainFooter: () => "Оставайтесь на связи с ₭𐌀Ɽ₥𐌀",
...
socialFollowUpFooter: () => "₭𐌀Ɽ₥𐌀 - Всегда на связи",
...
broadcastHeader: () => "꒷꒦ ✦ Сообщение от ₭𐌀Ɽ₥𐌀 ✦ ꒷꒦",
...
ytSearchMissingFiles: () => "❗ Для использования этой команды используйте базу ₭𐌀Ɽ₥𐌀",
...
translateFooter: () => "₭𐌀Ɽ₥𐌀 Переводчик",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *КАЗИНО*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ Как играть ✦ ꒷꒦\n\nВведите количество 💶 UnityCoins для ставки против *₭𐌀Ɽ₥𐌀-Bot*\n\n📌 Пример:\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ Выберите ставку ниже!\n╰★────★────★╯`,
