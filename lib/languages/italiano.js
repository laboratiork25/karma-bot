...
installIntro: () => "Vuoi installare ₭𐌀Ɽ₥𐌀 Bot sul tuo dispositivo?",
...
notAvailable: () => "⚠️ Questo comando è disponibile solo con la base di ₭𐌀Ɽ₥𐌀",
...
socialMainFooter: () => "Resta connesso con ₭𐌀Ɽ₥𐌀",
...
socialFollowUpFooter: () => "₭𐌀Ɽ₥𐌀 - Sempre connessi",
...
broadcastHeader: () => "• Messaggio da ₭𐌀Ɽ₥𐌀",
...
ytSearchMissingFiles: () => "❗ Per usare questo comando usa la base di ₭𐌀Ɽ₥𐌀",
...
betUsage: ({ prefix, command }) => `┌──────────\n   • 🎰 ୭ *CASINO*\n└──────────\n\n• Come giocare\n\nInserisci la quantità di 💶 UnityCoins da scommettere contro *₭𐌀Ɽ₥𐌀-Bot*\n\n📌 Esempio:\n${prefix}${command} 100\n\n┌──────────╮\n│ ˚. ᵎᵎ 🎲\n│ Scegli un taglio qui sotto!\n└──────────`,
betCooldown: ({ time }) => `┌──────────\n  ━━✫ 🚩 Hai già scommesso\n  ━━✫ Aspetta ⏱ ${time}\n└──────────`,
