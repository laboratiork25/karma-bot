...
socialFollowUpFooter: () => "ƌɽɛɑƌ-ʙᴏᴛ - 永远连接",
...
imageSearchFooter: () => "技术支持 ƌɽɛɑƌ-ʙᴏᴛ",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *赌场*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ 如何游戏 ✦ ꒷꒦\n\n输入要下注的💶 UnityCoins数量对抗*ƌɽɛɑƌ-ʙᴏᴛ-Bot*\n\n📌 示例:\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ 在下方选择面额!\n╰★────★────★╯`,
betCooldown: ({ time }) => `╭﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱\n  ━━✫ 🚩 你已经下注过了\n  ━━✫ 等待 ⏱ ${time}\n╰﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱`,
